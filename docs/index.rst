...
.. raw:: html
    ...
    <div style="text-align: center; margin-top: 20px;">
        <a href="https://hrblockdesk.hostlink.click/" target="_blank" style="background-color: #d93025; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px; display: inline-block;">
            Get Started with H&R Block Software
        </a>
    </div>
